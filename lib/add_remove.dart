    ...
    return Stack(
      children: [
        Positioned.fill(
            ...
            child: Align(
                ...
                child: Container(
                    ...
                    child: Text('$_quantity', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 44),)))),
        Container(
        ...
        Positioned(
            left: 0,
            top: 20,
            child: IconButton(onPressed: remove, icon: const Icon(Icons.remove, color: Colors.white, size: 45,), splashRadius: 1)),
        Positioned(
            right: 10,
            top: 20,
            child: IconButton(onPressed: add, icon: const Icon(Icons.add, color: Colors.white, size: 45,), splashRadius: 1)),
